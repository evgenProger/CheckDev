...
import ru.job4j.notification.config.MailConfiguration;
import ru.job4j.notification.domain.Notify;
import ru.job4j.notification.domain.Template;
import ru.job4j.notification.repository.SettingRepository;
import ru.job4j.notification.repository.TemplateRepository;
