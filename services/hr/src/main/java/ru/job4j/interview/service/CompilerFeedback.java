...
final public class CompilerFeedback {
    ...
    final public static class CompilerMessage {
        ...
        final public String typeOfProblemForDebugging;
        ...
        final public int textHighlightPosLineStart;
        final public int textHighlightPosProblemStart;
        final public int textHighlightPosProblemEnd;
        ...
        CompilerMessage(final Diagnostic<? extends JavaFileObject> diagnostic) {
            ...
            typeOfProblemForDebugging = "toString() = " + diagnostic.getKind().toString() + "; name() = " + typeOfProblem;
            ...
            textHighlightPosLineStart = (int) Math.min(Math.max(0, diagnostic.getStartPosition()), sourceLen);
            textHighlightPosProblemStart = (int) Math.min(Math.max(0, diagnostic.getPosition()), sourceLen);
            textHighlightPosProblemEnd = (int) Math.min(Math.max(0, diagnostic.getEndPosition()), sourceLen);
            ...
            codeOfConcern = sourceCode.substring(textHighlightPosProblemStart, textHighlightPosProblemEnd);
            codeOfConcernLong = sourceCode.substring(textHighlightPosLineStart, textHighlightPosProblemEnd);
        ...
        public String toStringForDebugging() {
            ...
            ret.append("Type of problem: ").append(typeOfProblemForDebugging).append("\n\n");
            ...
            ret.append("textHighlightPos_lineStart: ").append(textHighlightPosLineStart).append("\n");
            ret.append("textHighlightPos_problemStart: ").append(textHighlightPosProblemStart).append("\n");
            ret.append("textHighlightPos_problemEnd: ").append(textHighlightPosProblemEnd).append("\n");
