...
public interface VacancyRepository extends PagingAndSortingRepository<Vacancy, Integer> {
    ...
    @Query("select new ru.job4j.interview.domain.Vacancy(v.id, v.name, v.published, v.company, v.location, v.rate, v.experience) "
    ...
    @Query("select new ru.job4j.interview.domain.Vacancy(v.id, v.name, v.published, v.company, v.location, v.rate, v.experience) from vacancy as v "
